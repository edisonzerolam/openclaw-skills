...
│   │   └── rules.md       — Builder's identity and instructions
...
## Identity Files (rules.md)

Each agent gets a rules.md that defines:
...
Example rules.md for a builder agent:
